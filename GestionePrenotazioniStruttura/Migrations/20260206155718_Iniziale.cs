        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevisorStructureId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PriceForMonth = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activities_Structures_StructureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivitySubscription", x => new { x.ActivitiesId, x.SubscriptionsId });
                    table.ForeignKey(
                        name: "FK_ActivitySubscription_Activities_ActivitiesId",
                        column: x => x.ActivitiesId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivitySubscription_Subscriptions_SubscriptionsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_StructureId",
                table: "Activities",
                column: "StructureId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivitySubscription_SubscriptionsId",
                table: "ActivitySubscription",
